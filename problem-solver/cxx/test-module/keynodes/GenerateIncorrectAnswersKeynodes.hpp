...
{
public:
  static inline ScKeynode const action_generate_incorrect_answers{
      "action_generate_incorrect_answers",
  ...
  static inline ScKeynode const nrel_generated_question_model{
      "nrel_generated_question_model",
      ScType::ConstNodeNonRole};
